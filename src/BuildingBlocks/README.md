...
- `Taiken.SharedKernel` — базові типи (`Result`, strongly-typed ID, `Money`, базові абстракції
...
- `*.Contracts` кожного модуля може залежати лише на `SharedKernel`.
- BuildingBlocks не залежить ні на `Modules`, ні на `Integrations`, ні на `Fakes`.
